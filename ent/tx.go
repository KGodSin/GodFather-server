...
func (tx *Tx) init() {
	tx.Approval_information = NewApproval_informationClient(tx.config)
	tx.Product = NewProductClient(tx.config)
	tx.Product_order = NewProduct_orderClient(tx.config)
...
// applies a query, for example: Approval_information.QueryXXX(), the query will be executed
